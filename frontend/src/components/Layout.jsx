...
function Layout() {
  ...
  const drawerContent = (
    <Box sx={{ width: drawerWidth, p: 2 }}>
      <Typography variant="h5" sx={{ mb: 2, fontWeight: 'bold', color: theme.palette.primary.main }} className="oxygen-bold">
      MSE
      </Typography>
      <Divider sx={{ mb: 2 }} />
      {role === 'admin' ? (
  ...
  return (
    <Box className="oxygen-regular" sx={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      <CssBaseline />
      <AppBar
        position="fixed"
        sx={{
